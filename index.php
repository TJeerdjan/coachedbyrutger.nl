  ...
  <div class="video-testimonial-wrapper">
    <div class="video-testimonial-card" id="videoCard">
      ...
      <video id="testimonialVideo" muted loop playsinline preload="auto">
        <source src="https://app.direct-online.nl/uploads/3/semra_testimonial.webm" type="video/webm">
      </video>
  ...
  <div class="reviews-grid">
    ...
    try {
      ...
      foreach ($testimonials as $testimonial):
        ...
        $detail = htmlspecialchars($testimonial['client_title'] ?? '');
    ...
    <div class="review-card" data-testid="review-card">
      ...
      <p class="review-text"><?php echo $quote; ?></p>
      <div class="reviewer">
        <div class="reviewer-avatar"><?php echo $avatar; ?></div>
        <div class="reviewer-info">
          <div class="reviewer-name"><?php echo $name; ?></div>
          <div class="reviewer-detail"><?php echo $detail; ?></div>
        </div>
      </div>
    </div>
    <?php endforeach;
    } catch (Exception $e) {
      // Fallback: toon niets als alles faalt — pagina blijft intact
    }
    ?>
  </div>
